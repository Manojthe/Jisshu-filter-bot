...
PICS = (environ.get('PICS', 'https://graph.org/file/5c76782fca3ea53be9244.jpg')).split() #SAMPLE PIC
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002174393042') #Channel / Group Id for force sub ( make sure bot is admin )
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ: OG Team Bot Support')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001547162655')) #Log channel id ( make sure bot is admin )
